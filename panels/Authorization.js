...
import { View, Text, ToastAndroid, TextInput, Keyboard, StatusBar, TouchableNativeFeedback } from "react-native";
...
const Input = (props) => {
    ...
    return (
        ...
        >
            ...
            <TextInput
            value={value}
            keyboardType={isPassword && !secureTextEntry ? "visible-password" : type}
                        ...
                        <View>
                            <View style={{ marginTop: 25 }}>
                                ...
                                <View style={{ flexDirection: "row" }}>
                                    ...
                                    secureTextChange={setSecurePassword}
                                    isPassword
                                    />
                                </View>
                            </View>
